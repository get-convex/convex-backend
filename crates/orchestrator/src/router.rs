...
#[openapi(
    ...
    paths(
        ...
        crate::routes::management::deploy_keys::create_deploy_key,
        crate::routes::management::deploy_keys::list_deploy_keys,
        crate::routes::management::deploy_keys::delete_deploy_key,
        crate::routes::management::deploy_keys::create_preview_deploy_key,
        crate::routes::management::deploy_keys::list_preview_deploy_keys,
        crate::routes::management::deploy_keys::delete_preview_deploy_key,
        ...
        crate::routes::deployment_internal::team_and_project_for_key,
        crate::routes::deployment_internal::url_for_key,
        crate::routes::deployment_internal::authorize_prod,
        crate::routes::deployment_internal::authorize_preview,
    ...
    tags(
        ...
        (name = "deploy_keys", description = "/v1: per-deployment and preview deploy keys"),
