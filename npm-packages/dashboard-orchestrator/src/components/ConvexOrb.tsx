// Icon-only Convex logo (the orb), matching the cloud dashboard's Header.tsx.
// We inline the SVG rather than referencing /convex-logo-only.svg so colors
// and sizing match cloud exactly.

export function ConvexOrb({ size = 28 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
