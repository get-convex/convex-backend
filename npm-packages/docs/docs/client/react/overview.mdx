...
pagination_next: client/react/project-setup
---
...
2. Upload and display files from [File Storage](/file-storage/overview.mdx)
3. Authenticate users using [Authentication](/auth/overview.mdx)
4. Implement full text [Search](/search/overview.mdx) over your data
...
deployment URL. See
[Configuring Deployment URL](/client/react/project-setup.mdx) on how to pass in
the right value:
...
[`api`](/generated-api/api.mdx#api) object.
