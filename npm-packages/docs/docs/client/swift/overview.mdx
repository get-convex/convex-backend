...
pagination_next: client/swift/data-types
---
...
<Admonition type="tip">
  Use [Decodable structs](/client/swift/data-types.mdx#custom-data-types) to
  automatically convert Convex objects to Swift structs.
</Admonition>

<Admonition type="caution">
  * There are important gotchas when [sending and receiving
  numbers](/client/swift/data-types.mdx#numerical-types) between Swift and
  Convex. * Depending on your backend functions, you may need to deal with
  [reserved Swift keywords](/client/swift/data-types.mdx#field-name-conversion).
</Admonition>
...
When you're ready to move toward [production](/production/overview.mdx) for your
...
official [Convex Rust client](/client/rust.mdx). It handles maintaining a
