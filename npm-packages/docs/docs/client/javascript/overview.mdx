...
pagination_next: client/javascript/node
---
...
[React](/client/react/overview.mdx).
...
import Vanilla from "!!raw-loader!@site/../private-demos/snippets/src/vanilla.ts";

<Snippet title="script.ts" source={Vanilla} />
...
import Strings from "!!raw-loader!@site/../private-demos/snippets/src/strings.ts";

<Snippet title="script.ts" source={Strings} />
