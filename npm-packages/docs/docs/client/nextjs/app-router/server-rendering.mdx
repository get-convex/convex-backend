...
import UsePreloadedQuery from "!!raw-loader!@site/../private-demos/nextjs-app-router-snippets/app/Tasks.tsx";
import FetchQuery from "!!raw-loader!@site/../private-demos/nextjs-app-router-snippets/app/StaticTasks.tsx";
import ServerAction from "!!raw-loader!@site/../private-demos/nextjs-app-router-snippets/app/example/page.tsx";
import RouteHandler from "!!raw-loader!@site/../private-demos/nextjs-app-router-snippets/app/api/route.ts";
...
<Snippet title="app/TasksWrapper.tsx" source={PreloadQuery} />
...
<Snippet title="app/TasksWrapper.tsx" source={UsePreloadedQuery} />
...
<Snippet title="app/StaticTasks.tsx" source={FetchQuery} />
...
<Snippet title="app/example/page.tsx" source={ServerAction} />

Here's an example Route Handler calling a Convex mutation:

<Snippet title="app/api/route.ts" source={RouteHandler} />
...
[guaranteed consistency](/client/react/overview.mdx#consistency) provided by the
`ConvexReactClient`.
