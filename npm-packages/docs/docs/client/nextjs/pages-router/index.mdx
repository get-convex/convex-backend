...
import api from "!!raw-loader!@site/../demos/nextjs-pages-router/pages/api/clicks.ts";
...
components from `convex/react`, see the
...
<Snippet title="pages/api/clicks.ts" source={api} />
