...
import Config from "!!raw-loader!@site/../private-demos/snippets/convex/convex.config.ts";
...
- `convex/convex.config.ts` -
  [declares](/production/environment-variables#declaring) the
  `CONVEX_AUTH_TOKEN` environment variable that `loadOne` checks
- `convex/load.ts` - contains Convex function definitions
- `convex.go` - contains `Go` code that uses a generated, type-safe `HTTP`
  client.

<Snippet title="convex/convex.config.ts" source={Config} />

<Snippet title="convex/load.ts" source={Load} />
