...
With Convex
[preview deployments](/production/hosting/multiple-deployments.mdx#preview) your
...
5. All team members can make backend changes and test them out with their
   ...
   - Members of a team with the [Pro plan](https://www.convex.dev/pricing) can
     get separate
     [preview deployments](/production/hosting/multiple-deployments.mdx#preview)
     to test each other's pull-requests.
