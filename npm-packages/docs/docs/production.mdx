...
built-in limits, 24h support, and discounted usage-based pricing, or the
[Business](https://www.convex.dev/enterprise/pricing) plan for custom limits,
dedicated databases, SSO, and SLAs.
...
5. All team members can make backend changes and test them out with their
   ...
   - Members of a team with a [paid plan](https://www.convex.dev/pricing) can
     get separate
