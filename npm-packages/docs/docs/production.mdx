...
[Starter](https://www.convex.dev/pricing) plan to pay as you go, the
[Professional](https://www.convex.dev/pricing) plan for additional features,
higher built-in limits, 24h support, and discounted usage-based pricing, the
[Business](https://www.convex.dev/enterprise/pricing) plan for 1-50 developers,
custom deployments and workflows, SSO, dedicated databases, and service SLAs,
or the [Enterprise](https://www.convex.dev/enterprise/pricing) plan for
unlimited developers, custom contracts, higher SLAs, and peak performance.
...
5. All team members can make backend changes and test them out with their
   ...
   - Members of a team can get separate
