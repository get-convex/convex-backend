...
pagination_next: search/vector-search
---
...
[Convex Actions](/functions/actions.mdx) easily enable you to call AI apis, save
data to your database, and drive your user interface. See examples of how you
can use this to
[build sophisticated AI applications](https://stack.convex.dev/tag/AI).
