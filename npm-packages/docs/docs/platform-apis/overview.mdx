...
sidebar_position: 0
pagination_next: platform-apis/oauth-applications
---
...
<Admonition type="info">
  A team access token can only perform actions you have access to on the team.
  If you have [custom roles](/team-management/role-actions), the token can only
  perform the actions allowed by your roles.
</Admonition>
...
[Management API Reference](/management-api/overview)
...
To view the full list of commands, refer to the
