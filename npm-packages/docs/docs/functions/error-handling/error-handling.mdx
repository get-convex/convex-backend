...
which can be found on the [Logs](/dashboard/deployments/logs.mdx) page of a
given deployment.
...
[indexing your queries](/database/reading-data/indexes/indexes.mdx) to reduce
the number of documents scanned, allowing you to avoid unnecessary reads.
