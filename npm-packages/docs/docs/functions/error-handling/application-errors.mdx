...
import Client from "!!raw-loader!@site/../private-demos/snippets/src/applicationErrors.tsx";
...
You can pass the same [data types](/database/types.mdx) supported by function
