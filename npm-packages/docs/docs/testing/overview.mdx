...
pagination_next: testing/convex-test
---
...
- [Run functions from the command line](/cli/overview.mdx#run-convex-functions)
- [Run functions from the dashboard](/dashboard/deployments/functions.mdx#running-functions)

### Preview deployments

[Use preview deployments](/production/multiple-deployments.mdx#preview) to get
...
[Deploying Your App to Production](/production/overview.mdx#staging-environment).
