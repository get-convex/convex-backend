...
- [Claude Code](/ai/using-claude-code.mdx#setup-the-convex-mcp-server)
- [Codex](/ai/using-codex.mdx#setup-the-convex-mcp-server)
- [Conductor](/ai/using-conductor.mdx#setup-the-convex-mcp-server)
