...
When using <ClaudeCodeInlineMention /> or <CursorInlineMention />, we recommend installing the [Convex plugin](/ai/overview.mdx#plugins), which automatically starts the MCP server.
