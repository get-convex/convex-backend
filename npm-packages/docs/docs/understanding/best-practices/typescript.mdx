...
the database, authentication and any other Convex feature.
...
quickstart to get started with Convex.
...
Both TypeScript 6 and TypeScript 7 are supported, and Convex typechecks with the
