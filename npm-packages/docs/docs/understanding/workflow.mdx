...
[quickstarts](/quickstart/overview.mdx) to set this up.
...
[auth](/auth/overview.mdx) in your `convex/` folder, Convex ensures that they
are applied and enforced on your backend.

## Convex dashboard

The [Convex dashboard](/dashboard/deployments/deployments.mdx) will be a trusty
...
[in your dashboard](/dashboard/deployments/logs.mdx).

<Screenshot
  story="docs/pages/project/deployment/Logs"
  alt="Logs Dashboard Page"
/>

### Health, Data, Functions and more

- [Health](/dashboard/deployments/health.mdx) - provides invaluable information
  on how your app is performing in production, with deep insights on how your
  Convex queries are doing.
- [Data](/dashboard/deployments/data.mdx) - gives you a complete data browser to
  spot check your data.
- [Functions](/dashboard/deployments/functions.mdx) - gives you stats and run
  functions to debug them.

There is a lot more to to the dashboard. Be sure to click around or
[check out the docs](/dashboard/overview.mdx).
