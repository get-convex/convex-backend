...
<Details summary="Before you begin: You'll need Node.js 20+ and Git">

Ensure you have Node.js version 20 or greater installed on your computer. You
...
[efficient queries via indexes](/database/reading-data/indexes/indexes.mdx) and
traversing
