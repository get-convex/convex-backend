...
solution, we recommend using one of Convex's hosted plans:
[Free, Starter, and Professional](https://convex.dev/pricing) or
[Business and Enterprise](https://convex.dev/enterprise/pricing).
