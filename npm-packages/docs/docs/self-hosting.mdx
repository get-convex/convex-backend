...
[source-available backend](https://github.com/get-convex/convex-backend), and
...
## Source Available Convex Backend
...
You can do almost anything Apache-2.0 allows, except create another
product designed to squeeze out Convex Cloud. This ensures the
sustainability of Convex's development while giving the community
maximum freedom. All code was automatically converted to full
...
The client libraries and CLI are open-source.
