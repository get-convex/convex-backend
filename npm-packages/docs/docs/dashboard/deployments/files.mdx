...
[files stored in your deployment](/file-storage/overview.mdx). The page also
shows the files' storage IDs, size, and content type. You can upload new files
and download or delete existing files.
...
<Screenshot
  story="docs/pages/project/deployment/FileStorage"
  alt="The Files page of the dashboard"
/>
