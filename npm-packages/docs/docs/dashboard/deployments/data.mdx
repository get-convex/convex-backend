...
<Screenshot
  story="docs/pages/project/deployment/Data"
  alt="Data Dashboard Page"
/>
...
<Screenshot
  story="docs/pages/project/deployment/Data#Filters"
  alt="Data filters"
/>
...
<Screenshot
  story="docs/pages/project/deployment/Data#Custom Query"
...
<Screenshot
  story="docs/pages/project/deployment/Data#Custom Query Runner"
  alt="Running a custom test query"
/>
...
You can also write a [mutation](/functions/mutation-functions.mdx) directly in
the dashboard. This is useful for one-off data fixes, backfills, or quick
experiments while debugging your deployment.

In the `⋮` overflow menu at the top of the data page click on the “Custom
mutation" option.

This opens the same runner UI, but with the “Custom test mutation" option
selected. When you click “Run Custom Mutation", the mutation source is sent to
your deployment, executed, and any writes are committed if the mutation
succeeds.

Like custom queries, you can also open this UI from the persistent _fn_ button
shown on the bottom right of all deployment pages.
...
<Screenshot
  story="docs/pages/project/deployment/Data#Add Document"
  alt="Add document"
/>
...
<Screenshot
  story="docs/pages/project/deployment/Data#Context Menu"
  alt="Quick actions context menu"
/>
...
<Screenshot
  story="docs/pages/project/deployment/Data#Edit Inline"
  alt="Inline value editor"
/>
...
<Screenshot
  story="docs/pages/project/deployment/Data#Edit Document"
  alt="Edit entire document"
/>
...
<Screenshot
  story="docs/pages/project/deployment/Data#Bulk Edit"
  alt="Bulk edit documents"
/>
...
<Screenshot
  story="docs/pages/project/deployment/Data#Generate Schema"
  alt="Generate Schema button"
/>
