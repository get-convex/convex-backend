...
[command line](/cli/reference/data.mdx).
...
[running your deployed functions](/dashboard/deployments/functions.mdx#running-functions),
...
To see the [schema](/database/schemas.mdx) of your whole deployment, including
the relationships between tables, use the
[Schema page](/dashboard/deployments/schema.mdx).
...
[indexes](/database/reading-data/indexes/indexes.mdx) associated with the
selected table.
