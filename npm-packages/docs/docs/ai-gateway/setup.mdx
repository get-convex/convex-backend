...
`embedMany` from the [Vercel AI SDK](https://ai-sdk.dev/). It needs `convex`
1.45+ and AI SDK 7, and runs in the default runtime and
...
providers and is the recommended default. Use the native Messages or Responses
interface only when you need endpoint-specific provider features:
