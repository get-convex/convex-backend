...
{
  "error": {
    "message": "This endpoint is not supported by the Convex AI gateway. Supported endpoints: GET /v1/models, POST /v1/chat/completions, POST /alpha/decisions, POST /v1/embeddings, POST /v1/messages, POST /v1/responses. See https://docs.convex.dev/ai.",
    "type": "invalid_request_error",
