...
import Fields from "!!raw-loader!@site/../private-demos/snippets/convex/authFunctionsFields.ts";
...
Within a Convex [function](/functions/overview.mdx), you can access information
...
<Snippet source={Fields} title="convex/myFunctions.ts" />
