...
import tanstackStartSignIn from "!!raw-loader!@site/../private-demos/tanstack-start-workos/src/routes/sign-in.tsx";
import tanstackStartSignUp from "!!raw-loader!@site/../private-demos/tanstack-start-workos/src/routes/sign-up.tsx";
...
[Convex React Quickstart](/quickstart/react.mdx) first. Then:
  ...
  <StepByStep>
    ...
    <Step title="Show UI based on authentication state">
      ...
      Convex's `<Authenticated>`, `<Unauthenticated>`, `<AuthLoading>` and `<AuthRefreshing>` helper components.
  ...
  <StepByStep>
    ...
    <Step title="Add SSR auth in the root route">
      ...
      <Snippet
        ...
        highlightPatterns={[{ from: "beforeLoad", to: "^  \\}," }]}
      />
    ...
    <Step title="Add sign-in and sign-up redirect routes">
      ...
      <Snippet
        source={tanstackStartSignIn}
        title="src/routes/sign-in.tsx"
        highlightPatterns={["getSignInUrl", "Location"]}
      />

      <Snippet
        source={tanstackStartSignUp}
        title="src/routes/sign-up.tsx"
        highlightPatterns={["getSignUpUrl", "Location"]}
      />
