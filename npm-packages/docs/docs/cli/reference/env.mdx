...
- List all variables: <CodeWithCopyButton text={"npx convex env list"} />
...
- [`npx convex env list`](#list) — List all variables and their values
...
- List all default variables: <CodeWithCopyButton text={"npx convex env default list"} />
...
- <CodeWithCopyButton text={"npx convex env default list"} />
