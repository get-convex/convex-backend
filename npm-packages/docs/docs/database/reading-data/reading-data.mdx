...
[ordered based on the columns in the index](/database/reading-data/indexes/indexes.md#indexes-and-query-order)
...
See
[Limit expressions with indexes](/database/reading-data/indexes/indexes.md#limit-expressions-with-indexes)
for details.
