...
Dedicated deployments (D1024) have backups configured automatically for every 24
hours and accessible for up to 7 days. Backups are faster and cheaper due to the
