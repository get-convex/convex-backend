...
### Experimental: paginated query result object

[`usePaginatedQuery_experimental`](/api/modules/react#usepaginatedquery_experimental)
...
boolean. See the
[API reference](/api/modules/react#usepaginatedquery_experimental) for details.
