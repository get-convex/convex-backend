...
[database](/database/overview), and [client libraries](/client/react/overview)
in your app. Convex tracks the dependencies to your query functions, including
database changes, and triggers the subscription in the client libraries.
