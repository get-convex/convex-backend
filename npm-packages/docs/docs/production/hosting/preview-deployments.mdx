...
Convex preview deployments are automatically cleaned up 5 days (14 days on
Convex Professional, Business, and Enterprise plans) after creation, or when a
new preview deployment with the same name is created. They can also be manually
deleted from the Convex dashboard.
