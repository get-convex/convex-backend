...
You can pause a deployment from the
[deployment settings page](https://dashboard.convex.dev/deployment/settings/pause-deployment)
in the dashboard.
...
<Screenshot
  story="docs/components/PauseDeployment#Running"
  alt="Pause Deployment Button"
/>

A deployment can be resumed with this button on the same page:

<Screenshot
  story="docs/components/PauseDeployment#Paused"
  alt="Resume Deployment Button"
/>
