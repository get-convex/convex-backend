---
id: "values.VBoolean"
title: "Clase: VBoolean<Type, IsOptional>"
custom_edit_url: null
---

[values](../modules/values.md).VBoolean

El tipo del validador `v.boolean()`.
...
Solo para TypeScript, si esto es un validador de objeto, entonces
