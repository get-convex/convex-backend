---
id: "values.VString"
title: "Clase: VString<Type, IsOptional>"
custom_edit_url: null
---

[values](../modules/values.md).VString

El tipo del validador `v.string()`.
...
Solo para TypeScript: si se trata de un validador `Object`, este es el tipo de TypeScript de los nombres de sus propiedades.
