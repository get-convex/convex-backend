...
const ACTION_RESOURCE_KIND: Record<RoleStatementAction, ResourceKind> = {
  ...
  updateTeam: "team",
  deleteTeam: "team",
  applyReferralCode: "team",
  viewTeamAuditLog: "team",
  viewUsage: "team",
  // Billing
  updatePaymentMethod: "billing",
  updateBillingContact: "billing",
  updateBillingAddress: "billing",
  createSubscription: "billing",
  resumeSubscription: "billing",
  cancelSubscription: "billing",
  changeSubscriptionPlan: "billing",
  setSpendingLimit: "billing",
  viewBillingDetails: "billing",
  viewInvoices: "billing",
  // OAuth Applications
  createOAuthApplication: "oauthApplication",
  updateOAuthApplication: "oauthApplication",
  deleteOAuthApplication: "oauthApplication",
  viewOAuthApplications: "oauthApplication",
  generateOAuthClientSecret: "oauthApplication",
  // SSO
  enableSSO: "sso",
  disableSSO: "sso",
  updateSSO: "sso",
  viewSSO: "sso",
  // Team Integrations
  viewTeamIntegrations: "integration",
  createTeamIntegrations: "integration",
  updateTeamIntegrations: "integration",
  deleteTeamIntegrations: "integration",
  // Project
  ...
  updateMemberProjectRole: "project",
  // Default (project-scoped) Environment Variables
  createProjectEnvironmentVariable: "defaultEnvironmentVariable",
  updateProjectEnvironmentVariable: "defaultEnvironmentVariable",
  deleteProjectEnvironmentVariable: "defaultEnvironmentVariable",
  viewProjectEnvironmentVariables: "defaultEnvironmentVariable",
  // Deployment
  createDeployment: "deployment",
  receiveDeployment: "deployment",
  transferDeployment: "deployment",
  updateDeploymentReference: "deployment",
  updateDeploymentDashboardEditConfirmation: "deployment",
  updateDeploymentExpiresAt: "deployment",
  updateDeploymentSendLogsToClient: "deployment",
  updateDeploymentClass: "deployment",
  updateDeploymentIsDefault: "deployment",
  updateDeploymentType: "deployment",
  deleteDeployment: "deployment",
  viewDeployments: "deployment",
  viewDeploymentIntegrations: "deployment",
  writeDeploymentIntegrations: "deployment",
  createCustomDomain: "deployment",
  deleteCustomDomain: "deployment",
  viewInsights: "deployment",
  createBackups: "deployment",
  importBackups: "deployment",
  configurePeriodicBackups: "deployment",
  disablePeriodicBackups: "deployment",
  deleteBackups: "deployment",
  viewBackups: "deployment",
  deploy: "deployment",
  viewEnvironmentVariables: "deployment",
  writeEnvironmentVariables: "deployment",
  pauseDeployment: "deployment",
  unpauseDeployment: "deployment",
  viewLogs: "deployment",
  viewMetrics: "deployment",
  viewData: "deployment",
  writeData: "deployment",
  downloadBackups: "deployment",
  actAsUser: "deployment",
  runInternalQueries: "deployment",
  runInternalMutations: "deployment",
  runInternalActions: "deployment",
  runTestQuery: "deployment",
  viewAuditLog: "deployment",
  // Member
  inviteMember: "member",
  ...
  // Custom Role
  viewCustomRoles: "customRole",
  // Token
  createTeamAccessToken: "token",
  updateTeamAccessToken: "token",
  deleteTeamAccessToken: "token",
  viewTeamAccessTokens: "token",
  createProjectAccessToken: "token",
  updateProjectAccessToken: "token",
  deleteProjectAccessToken: "token",
  viewProjectAccessTokens: "token",
  createDeploymentAccessToken: "token",
  updateDeploymentAccessToken: "token",
  deleteDeploymentAccessToken: "token",
  viewDeploymentAccessTokens: "token",
};
