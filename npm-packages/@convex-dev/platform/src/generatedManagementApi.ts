...
export interface paths {
    ...
    "/deployments/{deployment_name}/delete_deploy_key": {
        ...
        /**
         * Delete deploy key
         * @description Deletes a deploy key for the specified deployment.
         * The `id` in the request body can be the full deploy key
         * (with prefix), encoded token, or the name of the deploy key.
         */
...
export interface components {
    schemas: {
        ...
        PlatformDeleteDeployKeyArgs: {
             ...
             * This can be the secret value of the token or its unique name.
             */
            id: string;
        };
