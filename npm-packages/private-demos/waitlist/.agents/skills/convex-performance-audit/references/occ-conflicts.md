...
Writes that do not change data still participate in conflict detection and
...
notifications, cache warming), the bookkeeping extends the transaction's
lifetime and read/write set.
